...
export declare type CanActAs = {
    type: "CanActAs";
    party: string;
};
export declare type CanReadAs = {
    type: "CanReadAs";
    party: string;
};
export declare type ParticipantAdmin = {
    type: "ParticipantAdmin";
};
export declare type UserRight = CanActAs | CanReadAs | ParticipantAdmin;
