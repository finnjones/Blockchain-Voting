...
describe('@daml/types', function () {
    ...
    it('nested genmap', function () {
        var _a = index_1.Map(index_1.Text, index_1.Map(index_1.Text, index_1.Text)), encode = _a.encode, decoder = _a.decoder;
        var decoded = index_1.emptyMap().set("a", index_1.emptyMap().set("b", "c"));
        var decode = function (u) { return decoder.runWithException(u); };
        var encoded = [["a", [["b", "c"]]]];
